...
window.addEventListener('DOMContentLoaded', function () {
  var tabs = __webpack_require__(/*! ./parts/tabs */ "./src/js/parts/tabs.js"),
      ...
      calculator = __webpack_require__(/*! ./parts/calculator */ "./src/js/parts/calculator.js"); // Tabs


  var parentTabSelector = ".info-header",
      tabSelector = ".info-header-tab",
      contentBlockSelector = ".info-tabcontent";
  tabs(parentTabSelector, tabSelector, contentBlockSelector); // Timer

  timer(); // Modal window

  modal(); // Send form

  var modalForm = document.querySelector('.main-form'),
      contactForm = document.querySelector('#form');
  form(modalForm);
  form(contactForm); // Slider
...
function modal() {
  var btnOpenModal = document.querySelectorAll('.description-btn'),
...
function tabs(parent, tabs, content) {
  var info = document.querySelector(parent),
...
function timer() {
  var diffTime = Math.abs(new Date().getTimezoneOffset() / 60);
  var deadline = "2020-05-15T00:00:00+0".concat(diffTime, ":00");
